...
Model.eo1 <- lm(Production_Accuracy ~ Helicopters*Language*Phase, data = dataLong)

influenceIndexPlot(Model.eo1)
outlierTest(Model.eo1)

Model.eo2 <- lm(Estimation_Accuracy ~ Helicopters*Language*Phase, data = dataLong)

influenceIndexPlot(Model.eo2)
outlierTest(Model.eo2)

Model.eo3 <- lm(TLX ~ Helicopters*Language*Phase, data = dataLong)

influenceIndexPlot(Model.eo3)
outlierTest(Model.eo3)

Model.eo4 <- lm(SCR ~ Helicopters*Language*Phase, data = dataLong)

influenceIndexPlot(Model.eo4)

Model.eo5 <- lm(HRV ~ Helicopters*Language*Phase, data = dataLong)
